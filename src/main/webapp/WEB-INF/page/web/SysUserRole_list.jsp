    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <form action="<%= basePath%>/biz/SysMerchantUnit_list.action" method="post" target="rightFrame">
                <li><span><input class="find" name="sysMerchantUnit.merchantName" placeholder="请输入商家名称或地址"><input
                        class="find1" type="submit" value="查询">
    	 </span></li>
            </form>
            <li class="clicks"><span><img src="<%=path%>/images/t01.png"/></span><a
                    href="<%= basePath%>/biz/SysMerchantUnit_openAdd.action">添加</a></li>
