...
<div class="formbody">
    ...
    <form action="<%= basePath%>/biz/SysUser_updateUserMessage.action" method="post" id="commonform">
        ...
        <ul class="forminfo">
            ...
            <li><label>旧密码</label><input id="oldPwd" name="oldPwd" type="password" class="dfinput"
                                         pwdValue="${sysUser.userPassword}"/><i><font color="#FF0000">*必填</font>6-16位字母、数字或下滑线组成</i><span
                    id="oldPasswd"></span></li>
