...
<div class="formbody">
    ...
    <form action="<%= basePath%>/biz/SysRight_update.action" method="post" id="commonform">
        ...
        <ul class="forminfo">
            ...
            <li><label>权限名称</label><input name="sysRight.rightName" type="text" class="dfinput"
                                          value="${sysRight.rightName}"/><i><font
                    color="#FF0000">*必填</font>不能超过20个汉字</i></li>
            <li><label>资源路径</label><input name="resourcePath" id="resourcePath" type="text" class="dfinput"
                                          value="${sysRight.resourcePath}"/></li>
            <li><label>权限类别</label><input name="sysRight.rightType" type="text" class="dfinput"
                                          value="${sysRight.rightType}"/><i><font color="#FF0000">*必填</font>1-4位整数</i>
            </li>
            <li><label>排序序号</label><input name="sysRight.rightSortOrder" type="text" class="dfinput"
                                          value="${sysRight.rightSortOrder}"/><i><font color="#FF0000">*必填</font>1-4位整数</i>
            </li>
