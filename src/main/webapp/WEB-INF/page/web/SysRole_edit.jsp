...
<div class="formbody">
    ...
    <form action="<%= basePath%>/biz/SysRole_update.action" method="post" id="commonform">
        ...
        <ul class="forminfo">
            ...
            <li><label>角色名称</label><input name="sysRole.roleName" type="text" class="dfinput"
                                          value="${sysRole.roleName}"/><i><font color="#FF0000">*必填</font>不能超过20个汉字</i>
            </li>
            <li><label>排序序号</label><input name="sysRole.roleSortOrder" type="text" class="dfinput"
                                          value="${sysRole.roleSortOrder}"/><i><font color="#FF0000">*必填</font></i></li>
